...
Updated on: xxxx-xx-xx
原文: https://github.com/Jack-Cherish/python-spider/commit/10610ab354fc1bb8264edc566766df6588111914
'''
import os
import sys
import re
...
class Encrypyed(object):
    ...
    def encrypted_request(self, text):
        ...
        enc_sec_key = self.rsa_encrpt(sec_key, self.puk_key, self.modules)
    ...
    def rsa_encrpt(self, text, pubKey, modules):
        text = text[::-1]
...
class Crawler(object):
    ...
    def __init__(self, timeout=60, cookie_path='.'):
        ...
        self.ep = Encrypyed()
        # try:
        #     for ind, cookie in enumerate(self.session.cookies):
        #         print "%d - %s" % (ind, cookie)
        #     self.session.cookies.load(ignore_discard=True)
        #     # self.session.cookies.save()
        # except Exception as e:
        #     click.echo('Cookie 未能加载, error: {e}'.format(e=e))
    ...
    def get_song_by_url(self, song_url, song_name, song_num, folder):
        ...
        if sys.platform == 'win32' or sys.platform == 'cygwin':  # 兼容系统windows or Cygwin
        ...
        if not os.path.exists(fpath):
            ...
            label = 'Downloading {} {}kb'.format(song_name.encode('utf-8'), int(length/1024))
...
class Netease(object):
    ...
    def download_song_by_search(self, song_name, song_num, folder='.'):
        ...
        try:
            ...
            click.echo('download_song_by_search error: {e}'.format(e=e))
        if song != None:
    ...
    def download_song_by_id(self, song_id, song_name, song_num, folder='.'):
        ...
        try:
            ...
            click.echo('download_song_by_id error: {e}'.format(e=e))
...
if __name__ == '__main__':
    ...
    if os.path.exists(music_list_name):
        with open(music_list_name, 'r') as fp:
            music_list = map(lambda x: x.strip(), fp.readlines())
